...
import fr.perrot54u.rugby.models.QuestionAModel;
import fr.perrot54u.rugby.views.Views;
import javafx.event.ActionEvent;
import javafx.scene.control.ChoiceBox;
import javafx.scene.control.TextArea;

public class QuestionAController {
    ...
    public void afficherJoueurs(ActionEvent actionEvent) {
        ...
        QuestionAModel model = new QuestionAModel();
        String string = model.afficherEquipe(listeEquipe.getValue());
